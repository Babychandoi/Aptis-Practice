// Chuẩn hoá tiêu đề, năm và độ hot cho 46 đề Writing Part 3.
//
// Chạy:
//   node scripts/gen-writing-part3-titles.js
//   docker exec -i aptis-mysql mysql -uaptis -paptis --default-character-set=utf8mb4 aptis < scripts/writing-part3-titles.sql
//   docker cp scripts/writing-part3-titles.mongo.js aptis-mongo:/tmp/w3.js
//   docker exec aptis-mongo mongosh --quiet --file /tmp/w3.js
//
// LÝ DO: file nguồn aptis_writing_part3_grouped_by_set.json chỉ có câu hỏi, không
// có tên chủ đề — nên lúc seed người ta tự đặt tên mô tả nội dung ("Writing Part 3
...
// (set 1 -> WRITING_PART_3_001). Đã đối chiếu nội dung câu hỏi để xác nhận:
//   set 1 hỏi "Where do you like to visit?"        -> Nature Club
//   set 3 hỏi "How do you learn about world news?" -> Debate Club
//   set 4 hỏi "When do you like reading books?"    -> Book Club
//
...
const dir = __dirname;
const PART_ID = '16000000-0000-4000-8000-000000000043';

/** Nguyên văn danh sách biên tập cung cấp, giữ đúng thứ tự chủ đề 1..46. */
const RAW_TITLES = [
  'Nature Club – Part 3 (2026) 🔥🔥🔥',
  'Outdoor Club - Part 3',
  'Debate Club - Part 3 (2026) 🔥🔥🔥',
  'Book Club - Part 3 (2026) 🔥🔥🔥',
  // Nguồn ghi nguyên câu đề bài "You are speaking to fellow members of the Home
  // Living Club in a group chat." — rút về tên club cho khớp các dòng khác.
  'Home Living Club - Part 3 (2026) 🔥🔥🔥',
  'Art Club – Part 3 (2026) 🔥🔥🔥🔥🔥',
  'Film Club - Part 3 (2026) 🔥🔥🔥🔥',
  'Language Club (Version 1) – Part 3 (2026) 🔥🔥🔥🔥🔥',
  'Writing Club - Part 3',
  'English Club (Version 1) – Part 3 (2026) 🔥🔥🔥🔥',
  'Television Club – Part 3 (2026) 🔥🔥',
  'Beautiful Homes Club - Part 3 (2026) 🔥🔥🔥',
  'Garden Club - Part 3 (2026) 🔥🔥🔥🔥',
  'Food Club – Part 3 (2026) 🔥🔥🔥🔥🔥',
  'Language Club (Version 2) – Part 3 (2026) 🔥🔥🔥🔥🔥',
  'English Club (Version 2) – Part 3 (2026) 🔥🔥🔥🔥',
  'Cinema Club - Part 3',
  'Nature Club (Version 2) - Part 3 (2026) 🔥🔥🔥',
  'Sports Club - Part 3 (2026) 🔥🔥🔥',
  'Reading Club – Part 3 (partial) (2026) 🔥🔥🔥',
  'English Club V3 – Confidence, Guests and Club Rules – Part 3 (2026) 🔥🔥🔥🔥',
  'Fashion Club – Part 3 (2026) 🔥🔥🔥',
  'Photography Club – Part 3 (2026) 🔥🔥🔥',
  'Technology Club – Part 3 (2026) 🔥🔥🔥🔥',
  'Business Club - Part 3 (2026) 🔥🔥🔥🔥',
  'Museum Club - Part 3 (2026) 🔥🔥🔥',
  'Movie Club - Part 3',
  'Computer Club - Part 3 (2026) 🔥🔥🔥',
  'College Club - Part 3',
  'English Club (Version 2) - Part 3 (2026) 🔥🔥🔥🔥',
  'Walking Club (Version 1) – Part 3 (2026) 🔥🔥🔥🔥',
  'Community Club – Part 3 (2026) 🔥🔥🔥🔥',
  'Travel Club (Version 2) - Part 3 (2026) 🔥🔥🔥',
  'Cooking Club - Part 3',
  'Car Club - Part 3 (2026) 🔥🔥🔥',
  'Travel Club – Part 3 (2026) 🔥🔥🔥',
  'Social Club – Part 3 (2026) 🔥🔥🔥🔥',
  'Home Living – Shared Spaces, Neighbourhoods and Heritage – Part 3 (2026) 🔥🔥🔥',
  'Music Club – Part 3 (2026) 🔥🔥🔥🔥',
  'Science Club - Part 3 (2026) 🔥🔥🔥🔥',
  'Fitness Club – Part 3 (2026) 🔥🔥🔥',
  'Healthy Club - Part 3',
  'Fitness Club – Flexible Exercise and Workplace Health – Part 3 (2026) 🔥🔥🔥',
  'Technology Club – Focus, Backups and Responsible AI – Part 3 (2026) 🔥🔥🔥🔥',
  'Walking Club V2 – Routes, Safety and Community – Part 3 (2026) 🔥🔥🔥🔥',
  'Food Club (Version 2) - Part 3 (2026) 🔥🔥🔥🔥🔥',
];
...
const parsed = RAW_TITLES.map((raw, index) => ({
  stt: index + 1,
  code: 'WRITING_PART_3_' + String(index + 1).padStart(3, '0'),
  ...parseTitle(raw),
}));

const esc = (value) => value.replace(/\\/g, '\\\\').replace(/'/g, "''");

const sql = `-- Chuẩn hoá tiêu đề Writing Part 3 theo danh sách biên tập.
--
...
`;
fs.writeFileSync(path.join(dir, 'writing-part3-titles.sql'), sql, 'utf8');
...
const mongoScript = `// SINH TỰ ĐỘNG bằng: node scripts/gen-writing-part3-titles.js
...
`;
fs.writeFileSync(path.join(dir, 'writing-part3-titles.mongo.js'), mongoScript, 'utf8');
